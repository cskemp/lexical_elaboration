...
# one divergent transition for the robustness set
expect_equal(nrow(subset(bayes_r %>% filter(!is.na(warnings)))), 1)
...
# there are 11 cases with divergent transitions
expect_equal(nrow(subset(bayes %>% filter(!is.na(warnings)))), 11)

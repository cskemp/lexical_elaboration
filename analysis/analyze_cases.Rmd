...
library(grImport)
grImport::PostScriptTrace( here("output", "figures", "main", "top", "svgedit.eps"), here("output", "figures", "main", "top", "svgedit.eps.xml"))
top_snow_pic <- grImport::readPicture( here("output", "figures", "main", "top", "svgedit.eps.xml"))
top_snow <- grImport::pictureGrob(top_snow_pic)
